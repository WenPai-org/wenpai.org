...
<div class="bbp-author-avatar-topic">
    <a href="<?php echo bbp_get_user_profile_url( bbp_get_reply_author_id() ); ?>">
        <?php echo get_avatar( bbp_get_reply_author_id(), 90 ); ?>
    </a>
</div>
	...
	<li class="bbp-topic-voice-count"><?php if(function_exists('the_views')) { the_views(); } ?></li>
