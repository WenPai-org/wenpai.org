...
$customizer_url          = '/customize/' . $site_slug . $return_home_param;
$customizer_identity_url = '/customize/identity/' . $site_slug . $return_home_param;
$settings_url            = '/settings/general/' . $site_slug;
