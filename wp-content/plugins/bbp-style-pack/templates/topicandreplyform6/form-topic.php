		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
				...
				<?php global $bsp_style_settings_form ;
					if (empty ($bsp_style_settings_form ['htmlActivate'])) { ?>
					<div class="bbp-template-notice">
						<ul>
				...
				<div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) ) : ?>
						...
						<?php global $bsp_style_settings_form ; ?>
						<?php if (!empty ($bsp_style_settings_form['topic_tag_list'])) { 
							bsp_topic_tags (bbp_get_topic_id()) ;
						}
						else {
						?>
					...
					<?php if ( bbp_is_subscriptions_active() && ! bbp_is_anonymous() && ( ! bbp_is_topic_edit() || ( bbp_is_topic_edit() && ! bbp_is_topic_anonymous() ) ) ) : ?>
						...
						<p class = "bsp_topic_subscription" >
					...
					<?php if ( bbp_allow_revisions() && bbp_is_topic_edit() ) : ?>
						...
						if (empty ($bsp_style_settings_form['Remove_Edit_LogsActivate'] ) || empty ($bsp_style_settings_form['Remove_Edit_ReasonActivate'] ))  {
							?>
							<fieldset class="bbp-form">
						<?php 
						}
							if (empty ($bsp_style_settings_form['Remove_Edit_LogsActivate'] )) {
							?>
								<fieldset class="bbp-form">
							<legend>
							...
							<?php } 
							if (empty ($bsp_style_settings_form['Remove_Edit_ReasonActivate'] )) {
							?>
								<div>
...
<?php else : ?>
	...
	<div id="no-topic-<?php bbp_forum_id(); ?>" class="bbp-no-topic">
		<div class="bbp-template-notice">
			...
			<?php do_action ('bsp_form_topic_login') ; ?>
		</div>
		<?php
		//addition to take out login form if set
		global $bsp_style_settings_form ;
		if (empty ($bsp_style_settings_form ['nologinActivate'])) { ?>
