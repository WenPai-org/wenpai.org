...
class Plugin {
	...
	public function form_topic_version_dropdown() {
		...
		?>
        <p>
            <label for="wp-version">选择你的 WordPress 版本：</label><br/>
            ...
            <label for="wp-other-version">输入 WordPress 版本号：</label>
            <input type="text" name="wp_other_version" id="wp-other-version"
                   value="<?php echo esc_attr( $other_version ); ?>">
        </p>
		<?php
	}
