<?php
gp_title( sprintf( __( '%s 翻译 &lt; 文派翻译平台' ),  esc_html( $sub_project->name ) ) );
...
<div class="project-header">
	<p class="project-description"><?php echo apply_filters( 'project_description', $sub_project->description, $project ); ?></p>
...
<div class="locale-project">
	<table class="gp-table locale-sub-projects">
		<thead>
			<tr>
				<th class="header"><?php _e( '集合 / 子项目' ); ?></th>
				<th><?php _e( '已翻译' ); ?></th>
				<th><?php _e( '模糊' ); ?></th>
				<th><?php _e( '未翻译' ); ?></th>
				<th><?php _e( '等待' ); ?></th>
...
<div class="locale-project-contributors">
	<div class="locale-project-contributors-group locale-project-contributors-contributors">
		...
		<table class="gp-table locale-project-contributors-table">
			<thead>
				<tr>
					<th class="contributor-details">贡献者</th>
					<th class="contributor-stats">翻译</th>
				</tr>
			</thead>
			<tbody>
			<?php
			foreach ( $locale_contributors['contributors'] as $contributor ) {
				...
				printf(
					'<tr id="contributor-%s">
						<td class="contributor-details">
							...
							<div class="contributor-name">
								<a href="https://profiles.wenpai.org/%s/">%s</a>
								<span>最近活跃：%s前</span>
							</div>
						</td>
					...
					$contributor->is_editor ? '<span class="translation-editor">审批者</span>' : '',
					$contributor->nicename,
		...
		if ( $locale_contributors['editors']['project'] ) :
			...
			<ul>
				...
				foreach ( $locale_contributors['editors']['project'] as $editor ) {
					printf(
						'<li><a href="https://profiles.wenpai.org/%s/">%s %s</a></li>',
						$editor->nicename,
			...
			?>
			<p>此项目当前没有审批者，您可以提交<a href="https://make.wordpress.org/polyglots/handbook/plugin-theme-authors-guide/pte-request/">审批者申请</a></p>
			<?php
		endif;
