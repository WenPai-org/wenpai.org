 ...
 *
 * wp wporg-translate show-stats --url=translate.wenpai.org
 */
...
class Stats {
	...
	public function __invoke( bool $echo_the_values = false ) {
		...
		// This value is only set in the production site (translate.wenpai.org).
	...
	private function print_header(): void {
		if ( ! $this->echo_the_values ) {
			...
			$this->header .= $this->create_gutenberg_paragraph( 'Created using the <b>wp wporg-translate show-stats --url=translate.wenpai.org</b> command.' );
		} else {
